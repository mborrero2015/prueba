...
*para corregir los cruces de inventarios entre dos insumos codcomp de unsumo por codcomp de otro
*select * from compins where codinsum=61 and codcomp not in (select  codcomp from auxapli where codinsum=61)
*select * from auxapli where codinsum=67 and codcomp not in (select  codcomp from compins where codinsum=67)
